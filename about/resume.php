...
<article class="wrapper">
  ...
  <section class="scroll" style="margin-bottom: 44px;">
    <!-- Training (Edu) -->
    ...
    <section class="item">
      <div class="resume__Card">
        ...
        <div class="res__work__Responsibilities">
          <ol class="fa-ul">
            <li><i class="fa-li fa fa-check-square-o" aria-hidden="true"></i> Utilized <a href="https://teamtreehouse.com/mistermoody" target="_blank">online</a> curriculum to learn web design practices</li>
  ...
  <section class="scroll">
    ...
    <section class="item">
      <div class="resume__sectionIntro">
        <p>Jack-of-all-trades, I am not, but my unique skill set helps me be the change that I want to see in the world!</p>
      </div>
      <div>
        <div class="grid-row">
              <div class="SkillBar">
...
<!-- <section class="resumeGrid">  
    ...
    <article class="resume__skills">
      <h2 class="res__sectionTitle">Talents</h2>
      <div><img src="img/tailorVanilla.jpg"></div>
      <div class="resume__sectionIntro">
        <p>Jack-of-all-trades, I am not, but my unique skill set helps me be the change that I want to see in the world!</p>
      </div>
      <div>
