<?php
$pageTitle = "Mister Moody CURRICULUMS";
  ...
  <article class="cur__TopicGrid">
    ...
    <section class="cur__TopicStyle">
      <div class="language">
        ...
        <div id="overlayLangArts" onclick="clickOffLangArts()">
          <div id="textLangArts">
            <p>
              LANGUAGE for ARTISTS ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Mi in nulla posuere sollicitudin aliquam ultrices sagittis. Dolor sed viverra ipsum nunc aliquet bibendum enim facilisis gravida. Consectetur purus ut faucibus pulvinar elementum integer enim. Sapien eget mi proin sed libero. <b>a 250 word Para</b> Nullam non nisi est sit amet facilisis magna etiam tempor. Sodales ut etiam sit amet. Proin sed libero enim sed faucibus turpis in eu mi. Mattis ullamcorper velit sed ullamcorper morbi tincidunt ornare massa. Vulputate eu scelerisque felis imperdiet proin fermentum. Nec nam aliquam sem et tortor. Lacus viverra vitae congue eu consequat. Turpis egestas integer eget aliquet nibh praesent tristique. Feugiat sed lectus vestibulum mattis ullamcorper. Diam donec adipiscing tristique risus nec feugiat in fermentum posuere. Facilisi cras fermentum odio eu feugiat pretium nibh. Pulvinar mattis nunc sed blandit libero. "C'est la vie~ 4 da win on dat reelnegusish!"
            </p>
          </div>
        </div>  
      </div>
    ...
    <section class="cur__TopicStyle">
      <div class="math">
        ...
        <div id="overlaySTEM" onclick="clickOffSTEM()">
          <div id="textSTEM">
            <p>
              STEM Math ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Mi in nulla posuere sollicitudin aliquam ultrices sagittis. Dolor sed viverra ipsum nunc aliquet bibendum enim facilisis gravida. Consectetur purus ut faucibus pulvinar elementum integer enim. Sapien eget mi proin sed libero. <b>a 250 word Para</b> Nullam non nisi est sit amet facilisis magna etiam tempor. Sodales ut etiam sit amet. Proin sed libero enim sed faucibus turpis in eu mi. Mattis ullamcorper velit sed ullamcorper morbi tincidunt ornare massa. Vulputate eu scelerisque felis imperdiet proin fermentum. Nec nam aliquam sem et tortor. Lacus viverra vitae congue eu consequat. Turpis egestas integer eget aliquet nibh praesent tristique. Feugiat sed lectus vestibulum mattis ullamcorper. Diam donec adipiscing tristique risus nec feugiat in fermentum posuere. Facilisi cras fermentum odio eu feugiat pretium nibh. Pulvinar mattis nunc sed blandit libero. "C'est la vie~ 4 da win on dat reelnegusish!"
            </p>
          </div>
        </div>  
      </div>
    ...
    <section class="cur__TopicStyle">
      <div class="id-card">
        ...
        <div id="overlayDigiCitizen" onclick="clickOffDigiCitizen()">
          <div id="textDigiCitizen">
            <p>
              DIGITAL CITIZENSHIP ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Mi in nulla posuere sollicitudin aliquam ultrices sagittis. Dolor sed viverra ipsum nunc aliquet bibendum enim facilisis gravida. Consectetur purus ut faucibus pulvinar elementum integer enim. Sapien eget mi proin sed libero. <b>a 250 word Para</b> Nullam non nisi est sit amet facilisis magna etiam tempor. Sodales ut etiam sit amet. Proin sed libero enim sed faucibus turpis in eu mi. Mattis ullamcorper velit sed ullamcorper morbi tincidunt ornare massa. Vulputate eu scelerisque felis imperdiet proin fermentum. Nec nam aliquam sem et tortor. Lacus viverra vitae congue eu consequat. Turpis egestas integer eget aliquet nibh praesent tristique. Feugiat sed lectus vestibulum mattis ullamcorper. Diam donec adipiscing tristique risus nec feugiat in fermentum posuere. Facilisi cras fermentum odio eu feugiat pretium nibh. Pulvinar mattis nunc sed blandit libero. "C'est la vie~ 4 da win on dat reelnegusish!"
            </p>
          </div>
        </div>  
      </div>
      <button class="modalBTN" onclick="clickOnDigiCitizen()">Learn More</button>
    </section>
  </article>
</main>
<!-- .....CONTENT-ENDS// --> 
