  ...
  <article class="resumeGrid">
    ...
    <section class="resume__education">
      ...
      <div class="resume__Card">
        ...
        <div class="res__work__Responsibilities">
          <ol>
            <li>Demonstrated proficiency using the Microsoft Office Suite</li>
          </ol>
        </div>
      </div>
      <div class="resume__Card">
        ...
        <div class="res__work__Responsibilities">
          <ol>
            <li>Completed 100&#45;hour curriculum on topics that included classroom management, lesson planning and teaching English grammar to non-native speakers.</li>
          </ol>
        </div>
      </div>
      <div class="resume__Card">
