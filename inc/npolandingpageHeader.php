...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Lovie's House Landing Page">
    ...
    -->
    <!-- Browser Tab Icon -->
    <link rel="icon" sizes="192x192" href="img/projectImages/logo.jpg" type="img/m" class="rounded">
    <link rel="apple-touch-icon" href="mg/projectImages/logo.jpg" type="img/m" class="rounded">  
